$().ready(function () {
    $("#a").click(function () {
        ...
        if (n > 1) {
            ...
            $.ajax({
                url: 'https://api.themoviedb.org/3/search/person?api_key=19f84e11932abbc79e6d83f82d6d1045&language=en-US&query='+valor+'&page=1&include_adult=false',
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        ...
                        url:'https://api.themoviedb.org/3/person/'+id+'?api_key=19f84e11932abbc79e6d83f82d6d1045&language=en-US',
                        ...
                        success: function (data) {
                            ...
                            var img = urlimages + data.profile_path;
                            ...
                            $("#vermais").click(function () {
                                ...
                                $("#ca").html(data.biography)
                                            
                                        $("#l3").html("biography: " + data.biography);
                                $("#l2").html("birthday: " + data.birthday);
                                $("#l1").html("page : " + data.homepage)
                                

                                if (data.profile_path) {
                                    document.getElementById("cardimg2").setAttribute("src", img);
                                }
